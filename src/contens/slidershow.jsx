        ...
        <>
          ...
          <div className="relative w-full glide-03">
            ...
            >
              ...
              >
                <span className="block w-2 h-2 transition-colors duration-100 rounded-full bg-white/20 ring-1 ring-slate-700 focus:outline-none"></span>
              </button>
              <button
                className="p-4 group"
                data-glide-dir="=1"
              ...
              >
                <span className="block w-2 h-2 transition-colors duration-100 rounded-full bg-white/20 ring-1 ring-slate-700 focus:outline-none focus:n-blue-500 "></span>
              </button>
              <button
                className="p-4 group"
                data-glide-dir="=2"
